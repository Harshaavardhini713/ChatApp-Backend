...
export default class Server {
    ...
    routes() {
        ...
        this.app.get("/contactPage", responseToPostman(async (req:Request, res: Response) => {
           ...
           return await ContactController.getAllUsers();
    ...
    //        throw new Error("User need to be logged in");
     //  }
       ...
       this.app.post("/api/v1/chat/getUserPersonalChat/:id", responseToPostman((req: Request, res: Response) => {
        console.log(req.params);
        return chatController.getUserPersonalChat(req.params.id);
    }));

    this.app.post("/api/v1/chat/getUserGroupChat/:id", responseToPostman((req: Request, res: Response) => {
        console.log(req.params);
       return chatController.getUserGroupChat(req.params.id);
    }));

    this.app.post("/api/v1/chat/searchChat/:id", responseToPostman((req: Request, res: Response) => {
        console.log(req.params);
       return chatController.searchChat(req.params.id);
    }));
